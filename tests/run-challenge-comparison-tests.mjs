...
if (!npmCli) throw new Error("Run the Prompt 11 suite through npm so the package-manager CLI can be resolved.");
...
run(process.execPath, [resolve(projectRoot, "node_modules", "@playwright", "test", "cli.js"), "test", "tests/e2e/challenge-landing.spec.ts"], reviewEnvironment);
