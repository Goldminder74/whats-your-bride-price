...
export const regions: Record<RegionKey, Region> = {
  ...
  north: {
    ...
    questions: [
      ...
      q("complete", "Complete the Arabic proverb: ‘Patience is the key to ___.’", ["relief", "silence", "wealth", "travel"], [0], "Al-sabr miftah al-faraj—‘patience is the key to relief’—is heard across Arabic-speaking North Africa.", "PROVERBS"),
    ],
  },
  south: {
